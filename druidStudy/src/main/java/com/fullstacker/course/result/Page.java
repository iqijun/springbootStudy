package com.fullstacker.course.result;


import com.fullstacker.course.entity.UserEntity;
import com.fullstacker.course.param.PageParam;
...
public class Page<E> implements Serializable {
    ...
    public static void main(String[] args){
        ...
        userEntityPage.setList(userEntities);
        System.out.println(userEntityPage.toString());
    }
}
